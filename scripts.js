...
function addMore(x,q)
{
   switch(x)
   {
      case 1: h[q-1]++; document.getElementById(q+"addStuff").innerHTML = document.getElementById(q+"addStuff").innerHTML + "<!----><br class='less'><h3><a id='"+q+"xd"+h[q-1]+"'>1</a>d<a id='"+q+"dx"+h[q-1]+"'>20</a> +<a id='"+q+"c"+h[q-1]+"'>0</a>  <a id='"+q+"t"+h[q-1]+"'></a></h3><h4><a id='"+q+"a1a"+h[q-1]+"' class='point' onclick='addDice(1,"+h[q-1]+","+q+");'>+1</a>  <a id='"+q+"a2a"+h[q-1]+"' class='point' onclick='addDice(-1,"+h[q-1]+","+q+");'>-1</a> | <a id='"+q+"a3a"+h[q-1]+"' class='point' onclick='addFace(1,"+h[q-1]+","+q+");'>+1</a>  <a id='"+q+"a4a"+h[q-1]+"' class='point' onclick='addFace(-1,"+h[q-1]+","+q+");'>-1</a> | <a id='"+q+"a5a"+h[q-1]+"' class='point' onclick='addMod(1,"+h[q-1]+","+q+");'>+1</a>  <a id='"+q+"a6a"+h[q-1]+"' class='point' onclick='addMod(-1,"+h[q-1]+","+q+");'>-1</a></h4>"; break;
...
function addMOAR(x,q)
{
   ...
   {
      h[h.length] = 1;
      document.getElementById("extremeWack").innerHTML = document.getElementById("extremeWack").innerHTML + "<!--hhh--><div class='dice' id='"+h.length+"'><h2>Roll Time: <a id='"+h.length+"result'></a></h2><h3><a id='"+h.length+"xd1'>1</a>d<a id='"+h.length+"dx1'>20</a> +<a id='"+h.length+"c1'>0</a>  <a id='"+h.length+"t1'></a></h3><h4><a id='"+h.length+"a1a1' class='point' onclick='addDice(1,1,"+h.length+");'>+1</a>  <a id='"+h.length+"a2a1' class='point' onclick='addDice(-1,1,"+h.length+");'>-1</a> | <a id='"+h.length+"a3a1' class='point' onclick='addFace(1,1,"+h.length+");'>+1</a>  <a id='"+h.length+"a4a1' class='point' onclick='addFace(-1,1,"+h.length+");'>-1</a> | <a id='"+h.length+"a5a1' class='point' onclick='addMod(1,1,"+h.length+");'>+1</a>  <a id='"+h.length+"a6a1' class='point' onclick='addMod(-1,1,"+h.length+");'>-1</a></h4><div id='"+h.length+"addStuff'></div><h6 id='"+h.length+"z1' onclick='addMore(1,"+h.length+");'>Add More Dice</h6><h6 id='"+h.length+"z2' onclick='addMore(-1,"+h.length+");'>Add Less Dice</h6><h5 id='"+h.length+"z3' onclick='doThing("+h.length+");'>Generate</h5><p>Test: <a id='"+h.length+"re'>1</a></p><p class='delet' id='"+h.length+"z4' onclick='addMOAR(-1,"+h.length+")'>Remove Dice Set</p></div>";
   }
}
